...
class Diklat extends CI_Controller
{
	...
	public function index()
    {
        ...
        $this->load->view('nonpns/v_data_diklat',$data);
    ...
    public function diklat_perpanjang()
    {
        ...
        $this->load->view('template/header_nonpns',$data);
        $this->load->view('template/sidebar_nonpns',$data);
        $this->load->view('nonpns/v_diklat_nonpns',$data);
        $this->load->view('template/footer');
    }
    ...
    public function update_diklat_expired()
    {
        ...
        redirect('nonpns/Diklat/diklat_perpanjang'); 
    }
    ...
    public function tambah_diklat()
    {
        ...
        if ($file=''){}else{
            $config ['upload_path']     =   './uploads/non-pns/diklat';
        ...
        $file     = $_FILES['file']['name'];
            if ($file){
                ...
                if($this->upload->do_upload('file')){
                    ...
                    {
                     $taget_file = './uploads/non-pns/diklat/'.$uploadfile->file;
                     unlink($taget_file);
                    }
                    $file=$this->upload->data('file_name');
    ...
    public function delete_diklat($id)
    {
        ...
        if($berkas->file != null)
        {
            $taget_file = './uploads/non-pns/diklat/'.$berkas->file;
            unlink($taget_file);
        }
    ...
    public function delete_diklat_detail($id)
    {
        ...
        $this->master_m->delete_data($where, 'data_diklat');
        $this->session->set_flashdata('flash', 'Dihapus');
        redirect('admin/Datapegawai/detail_diklat_nonpns/'.$nip);
    }
