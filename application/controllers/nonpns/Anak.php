...
class Anak extends CI_Controller
{
	...
	public function index()
    {
        ...
        $this->load->view('nonpns/v_data_anak',$data);
    ...
    public function tambah_anak()
    {
            ...
            if ($file=''){}else{
                $config ['upload_path']     =   './uploads/non-pns/anak';
    ...
    public function update_anak()
    {
            ...
            if ($file){
                ...
                if($this->upload->do_upload('file')){
                    ...
                    {
                     $taget_file = './uploads/non-pns/anak/'.$uploadfile->file;
                     unlink($taget_file);
                    }
                    $file=$this->upload->data('file_name');
    ...
    public function delete_anak($id)
    {
        ...
        if($berkas->file != null)
        {
            $taget_file = './uploads/non-pns/anak/'.$berkas->file;
            unlink($taget_file);
        }
    ...
    public function delete_anak_detail($id)
    {
        ...
        $this->master_m->delete_data($where, 'data_anak');
        $this->session->set_flashdata('flash', 'Dihapus');
        redirect('admin/Datapegawai/detail_anak_nonpns/'.$nip);
    }
