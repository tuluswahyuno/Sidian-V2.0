...
class Pasangan extends CI_Controller
{
	...
	public function index()
    {
        ...
        $this->load->view('pns/v_data_pasangan',$data);
    ...
    public function tambah_pasangan()
    {
            ...
            if ($akta_nikah=''){}else{
                $config ['upload_path']     =   './uploads/pasangan';
    ...
    public function update_pasangan()
    {
            ...
            if ($akta_nikah){
                ...
                if($this->upload->do_upload('akta_nikah')){
                    ...
                    {
                     $taget_file = './uploads/pasangan/'.$uploadfile->akta_nikah;
                     unlink($taget_file);
                    }
                    $akta_nikah=$this->upload->data('file_name');
            ...
            if ($akta_cerai){
                ...
                if($this->upload->do_upload('akta_cerai')){
                    ...
                    {
                     $taget_file = './uploads/pasangan/'.$uploadfile->akta_cerai;
                     unlink($taget_file);
                    }
                    $akta_cerai=$this->upload->data('file_name');
