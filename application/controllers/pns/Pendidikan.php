...
class Pendidikan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('pns/v_data_pendidikan',$data);
    ...
    public function tambah_pendidikan()
    {
            ...
            if ($ijazah=''){}else{
                $config ['upload_path']     =   './uploads/pendidikan';
    ...
    public function update_pendidikan()
    {
            ...
            if ($ijazah){
                ...
                if($this->upload->do_upload('ijazah')){
                    ...
                    {
                     $taget_file = './uploads/pendidikan/'.$uploadfile->ijazah;
                     unlink($taget_file);
                    }
                    $ijazah=$this->upload->data('file_name');
            ...
            if ($transkrip){
                ...
                if($this->upload->do_upload('transkrip')){
                    ...
                    {
                     $taget_file = './uploads/pendidikan/'.$uploadfile->transkrip;
                     unlink($taget_file);
                    }
                    $transkrip=$this->upload->data('file_name');
    ...
    public function delete_pendidikan($id)
    {
        ...
        {
            $taget_file = './uploads/pendidikan/'.$berkas->ijazah;
            unlink($taget_file);
        }

        if($berkas->transkrip != null)
        {
            $taget_file = './uploads/pendidikan/'.$berkas->transkrip;
            unlink($taget_file);
        }
