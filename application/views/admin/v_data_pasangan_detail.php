            ...
            <tbody>
              ...
              <tr>
               <td style="text-align: center;"><?php echo $no++; ?></td>
                <td style="text-align: center;"><?php echo $us->pasangan ?></td>
                ...
                <td style="text-align: center;">
                   ...
                   <?php } elseif ($us->akta_nikah != NULL && $us->akta_cerai != NULL) { ?>
                    ...
                    <a class="btn btn-sm btn-danger" href="<?php echo base_url() . 'uploads/pasangan/' . $us->akta_nikah ?>" target="_blank"> Akta Cerai <i class="fas fa-eye"> </a></i>
