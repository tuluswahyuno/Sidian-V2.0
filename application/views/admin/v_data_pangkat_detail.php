  ...
  <div class="content-wrapper">
    <section class="content-header">
          <div class="col-sm-12">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="<?php echo base_url('admin/Datapegawai/detail_pangkat/').$detail->nip ?>">Kepangkatan</a>
            </li>
          ...
          <table class="table table-hover table-striped table-bordered" id="table1">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="text-align: center;"><?php echo $us->tmt ?></td>
